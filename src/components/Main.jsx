          ...
          <div className="flex flex-row h-full w-full overflow-x-hidden">
            <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
              <div className="flex flex-row items-center justify-center h-12 w-full">
                ...
                <div className="ml-2 font-bold text-2xl"><span classNameName="text-indigo-500">Chatre</span><span classNameName="text-gray-500">Box</span></div>
              </div>
              <div
                        ...
                        <div className="flex flex-row items-center">
                          ...
                          >
                            <div className="relative w-10 h-10">
                              <img className="w-10 h-10 rounded-full" src="https://cdn.icon-icons.com/icons2/2643/PNG/512/male_man_people_person_avatar_white_tone_icon_159363.png" alt=""/>
