...
const Login = ({setUser}) => {
  ...
  return (
    <div className="min-h-screen bg-indigo-50 flex justify-center items-center">
      <div className="absolute w-60 h-60 rounded-xl bg-indigo-300 -top-5 -left-16 z-0 transform rotate-45 hidden md:block"></div>
      ...
      <div class="relative py-3 sm:max-w-xl sm:mx-auto">
		    ...
		    <div class="relative bg-white shadow-lg rounded-3xl px-20 py-16">
              ...
              <div className="flex flex-row items-center justify-center h-12 w-full">
                ...
                <div className="ml-2 font-bold text-2xl"><span className="text-indigo-500">Chatre</span><span className="text-gray-500">Box</span></div>
              </div>
            </div>
                  ...
                  {/* {errorAlert && errorAlert.hasOwnProperty("mobile_no") && (
                    <span className="animate-view-content">
                      {errorAlert["mobile_no"]}
						    ...
						    <div class="relative">
							    <button class="w-full py-2 text-xl text-white bg-purple-400 rounded-lg hover:bg-purple-500 transition-all mt-6" onClick={checkName}>Join</button>
						    </div>
					    </div>
				    </div>
			    </div>
